...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSignupENDCLASS_t qt_meta_stringdata_CLASSSignupENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 10),  // "signupInfo"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 5),  // "email"
        QT_MOC_LITERAL(25, 8),  // "password"
        QT_MOC_LITERAL(34, 12),  // "confPassword"
...
void Signup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signupInfo((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        ...
        {
            using _t = void (Signup::*)(const QString & , const QString & , const QString & );
            if (_t _q_method = &Signup::signupInfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Signup::signupInfo(const QString & _t1, const QString & _t2, const QString & _t3)
{
